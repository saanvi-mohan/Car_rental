				...
				<div class="box">
					...
					<form action="" method="post" enctype="multipart/form-data">
						...
						<div class="form">
								...
								<p>
									<span class="req">Select Vehicle Type</span>
								...
								<p>
									...
									<input type="number" class="field size1" name="hire_cost" required />
								</p>
								<p>
								...
								<p>
									<span class="req">Number Plate Information</span>
									<label>Vehicle Number</label>
									<input type="text" class="field size1" name="car_no" />
								</p>	
								<p>
					...
					<?php
							if(isset($_POST['send'])){
								...
								$qr = "INSERT INTO cars (image, car_name,car_type,type,hire_cost,car_no,capacity,status) 
													VALUES ('$image','$car_name','$car_type','$type','$hire_cost','$car_no','$capacity','Available')";
								$res = $conn->query($qr);
								if($res === TRUE){
...
<div id="footer">
	<div class="shell">
		<span class="left">Copyright &copy; <?php echo date("Y"); ?> - All Rights Reserved</span>
		<span class="right">
			Designed and Developed by<a href= "https://www.instagram.com/sarang_1407/"> Sarang Dev Saha </a>
		</span>
	</div>
</div>
<!-- End Footer -->
