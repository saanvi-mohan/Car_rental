					...
					<div class="table">
						<table width="100%" style="border: 0" cellspacing="0" cellpadding="0">
							<tr>
								...
								<th>Client Name</th>
								<th>Phone Number</th>
								<th><a href="requests_desc.php">Car Booked  <img src="../img/up.png" width="10" height="10"></th>
								<th>Mpesa ID</th>
								<th>Status</th>
							...
							<?php
								...
								$select = "SELECT client.client_id,client.fname,client.phone,cars.car_name,cars.hire_cost,client.status 
										FROM client JOIN cars ON client.car_id=cars.car_id ORDER BY car_name ASC";
