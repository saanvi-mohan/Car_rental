					...
					<div class="table">
						<table width="100%" style="border: 0" cellspacing="0" cellpadding="0">
							<tr>
								...
								<th>Client Name</th>
								<th>Phone Number</th>
								<th><a href="client_requests.php">Car Booked  <img src="../img/down.png" width="10" height="10"></th>
								<th>Mpesa ID</th>
								<th>Status</th>
							...
							<?php
								...
								$select = "SELECT client.client_id,client.fname,client.phone,cars.car_name,cars.hire_cost,client.status 
										FROM client JOIN cars ON client.car_id=cars.car_id ORDER BY car_name DESC";
...
<div id="footer">
	<div class="shell">
		...
		<span class="right">
			Designed and Developed by<a href= "https://www.instagram.com/sarang_1407/"> Sarang Deb Saha </a>
		</span>
	</div>
</div>
<!-- End Footer -->
